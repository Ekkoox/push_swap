...
/*   Updated: 2024/04/17 17:43:31 by enschnei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void b_to_a(t_swap **a, t_swap **b)
{
	...
	while(cheap_cost->index != 0 || cheap_cost->target->index != 0)
	{
		if (cheap_cost->above_median == 1 && cheap_cost->target->above_median == 1)
			rotate_up_median(a, b, cheap_cost);
		else if (cheap_cost->above_median == 0 && cheap_cost->target->above_median == 0)
			rotate_down_median(a, b, cheap_cost);
		else if (cheap_cost->above_median == 1 && cheap_cost->target->above_median == 0)
